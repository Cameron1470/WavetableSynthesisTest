    ...
    : AudioProcessorEditor(&p), audioProcessor(p)
{
    ...
    filterEnvAmpSlider.setRange(0, 2);
    ...
    filterEnvAmpTree = new juce::AudioProcessorValueTreeState::SliderAttachment(audioProcessor.parameters, "env_amp", filterEnvAmpSlider);
